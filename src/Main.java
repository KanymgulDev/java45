...
public class Main {
    ...
    public static void perevod1() {
        Scanner scanner = new Scanner(System.in);
        Account account = new Account();
        System.out.println("Канча сом которгунуз келет lira?");
        ...
        System.out.println("lira akchasy:"+otv);
    ...
    public static void perevod2() {
        Scanner scanner = new Scanner(System.in);
        Account account = new Account();
        System.out.println("Канча сом которгунуз келет merrimge?");
        ...
        System.out.println("merrimge akchasy:" + resl);
    }
}
